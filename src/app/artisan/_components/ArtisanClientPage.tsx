...
import { updateContent, type CalendarItem } from '@/app/calendar/actions';
...
interface ArtisanClientPageProps {
    initialProfile: Profile;
    initialOfferings: Offering[];
    initialArtisanItems: ArtisanItem[];
    initialMediaPlans: MediaPlanSelectItem[];
}
