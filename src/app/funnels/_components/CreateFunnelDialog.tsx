            ...
            <DialogContent className="sm:max-w-7xl">
                ...
                <div className={cn("grid grid-cols-1 gap-12", generatedContent ? "lg:grid-cols-2" : "grid-cols-1")}>
                    <div className="space-y-8 py-4 max-h-[70vh] overflow-y-auto pr-6">
                        ...
                        <div className="space-y-4"><Label htmlFor="offering-select" className="text-lg font-semibold">Choose an Offering</Label><Select onValueChange={setSelectedOfferingId} value={selectedOfferingId || undefined}><SelectTrigger id="offering-select" className="text-base py-6"><SelectValue placeholder="Select an offering to promote..." /></SelectTrigger><SelectContent>{offerings.map(o => (<SelectItem key={o.id} value={o.id}>{o.title.primary}</SelectItem>))}</SelectContent></Select></div>
