      ...
      <div className="p-4 sm:p-6 lg:p-8 space-y-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 space-y-8">
            <Card className="bg-primary text-primary-foreground rounded-2xl shadow-lg relative overflow-hidden">
          ...
          <div className="space-y-8">
            ...
            <Card className="bg-primary/10 border-primary/20 rounded-2xl shadow-sm relative overflow-hidden backdrop-blur-sm">
