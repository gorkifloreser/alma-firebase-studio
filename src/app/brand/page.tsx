...
import { getBrandDocuments, deleteBrandDocument, uploadBrandDocument, askRag, processAndEmbedDocument } from '../knowledge-base/actions';
...
export default async function BrandPage() {
    ...
    const tabData = {
        ...
        knowledgeBase: {
            ...
            askRagAction: askRag,
            processAndEmbedDocumentAction: processAndEmbedDocument,
        },
        accounts: {
